-- Unified Kairo AI Database Schema
-- Combines existing schema with new advanced features
-- Avoids conflicts and maintains backward compatibility

-- ============================================================================
-- EXISTING TABLES (from database/kairo-ai-schema.sql) - Keep as is
-- ============================================================================

-- Kairo AI Conversations Table (EXISTING - Enhanced)
...
-- Financial Goals Table (EXISTING - Keep as is)
...
-- AI Insights and Recommendations Table (EXISTING - Enhanced)
...
-- User AI Preferences Table (EXISTING - Keep as is)
...
-- AI Learning Data Table (EXISTING - Keep as is)
...
-- Financial Health Scores Table (EXISTING - Keep as is)
...
-- ============================================================================
-- NEW TABLES (Additional advanced features)
-- ============================================================================

-- AI model performance tracking (NEW)
...
-- AI predictions table for tracking prediction accuracy (NEW)
...
-- AI analytics cache for admin dashboard (NEW)
...
-- ============================================================================
-- ROW LEVEL SECURITY (Existing + New)
-- ============================================================================
...
-- Function for automatic timestamp updates (EXISTING)
...
-- Function to update feature usage (NEW)
...
-- Cleanup function for old data (NEW)
