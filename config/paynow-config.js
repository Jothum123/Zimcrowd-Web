...
const PayNowConfig = {
    ...
    // ZWG Integration
    zwg: {
        integrationId: process.env.PAYNOW_ZWG_INTEGRATION_ID || '22100',
    ...
    // URLs and Endpoints
    urls: {
        resultUrl: process.env.PAYNOW_RESULT_URL || 'https://zimcrowd-backend.vercel.app/api/paynow/result',
        returnUrl: process.env.PAYNOW_RETURN_URL || 'https://zimcrowd.com/payment/return',
    ...
    settings: {
        ...
        merchantEmail: process.env.PAYNOW_MERCHANT_EMAIL || 'jothum@zimcrowd.co.zw',
